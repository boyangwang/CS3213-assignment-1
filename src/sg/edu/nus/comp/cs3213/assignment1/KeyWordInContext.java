...
public class KeyWordInContext {
	...
	private static String processInput(String input) {
		...
		case COMMAND_NUMBER_ADD_ENTRIES_FILE:
			...
			try {
				entryList = readFileToList(entryPath,
						READ_FILE_TYPE_ENTRY);
		...
		case COMMAND_NUMBER_ADD_IGNORE_FILE:
			...
			try {
				ignoreList = readFileToList(ignorePath,
						READ_FILE_TYPE_IGNORE);
	...
	private static ArrayList<String> readFileToList(String path,
			int readFileType) throws FileNotFoundException {
